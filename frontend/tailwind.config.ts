    ...
    extend: {
      colors: {
        ...
        primary: {
          ...
          "muted-strong": "hsl(var(--primary-muted-strong))",
        },
        secondary: {
        ...
        warning: {
          ...
          "muted-strong": "hsl(var(--warning-muted-strong))",
        },
        info: {
        ...
        status: {
          confident: "hsl(var(--status-confident))",
      ...
      // Soft shadows (DATEV-nah: minimal, professional)
      boxShadow: {
