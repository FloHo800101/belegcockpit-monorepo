 ...
 * Nutzt das korrekte Layout-Pattern (h-full flex flex-col) wie OpenItems.
 */
export default function MonthAmpel() {
  ...
  const handleDetailedView = () => navigate(`/mandant/monat/${monthId}/offene-punkte`);
  const handleBack = () => navigate(`/mandant/monat/${monthId}/setup`);
  const handleFinish = () => navigate(`/mandant/monat/${monthId}/abschluss`);
  ...
  return (
    <div className="h-full flex flex-col">
              ...
              {uncertainTxs.length > 0 && (
                <CardContent className="pt-0 ml-8">
                  <ul className="space-y-1.5">
                    ...
                    {uncertain > 5 && (
                      <li className="text-xs text-muted-foreground">+ {uncertain - 5} weitere</li>
                    )}
                  </ul>
                </CardContent>
              )}
              ...
              {missingTxs.length > 0 && (
                <CardContent className="pt-0 ml-8">
                  <ul className="space-y-1.5">
                    ...
                    {missing > 5 && (
                      <li className="text-xs text-muted-foreground">+ {missing - 5} weitere</li>
                    )}
                  </ul>
                </CardContent>
              )}
      ...
      {/* Footer – nicht fixed, Teil des Flex-Layouts (wie WizardFooterBar) */}
      <footer className="flex-shrink-0 bg-card border-t py-4 px-6">
