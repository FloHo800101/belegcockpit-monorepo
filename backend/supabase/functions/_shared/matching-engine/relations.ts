import { Doc, Tx, DocCandidate, Relation, RelationSet } from "./types.ts";
import { MatchingConfig, amountCompatible, calcWindow } from "./config.ts";
import { resolveDocAmountMatch } from "./amount-candidates.ts";
import { vendorCompatible } from "./vendor.ts";
import { docPartyNormForTx, docPartyNorms } from "./doc-party.ts";
