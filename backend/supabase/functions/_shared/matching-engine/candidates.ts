import { Doc, Tx, DocCandidate, FeatureVector } from "./types.ts";
import { MatchingConfig, calcWindow, daysBetween } from "./config.ts";
import { matchInvoiceNoInText, normalizeText } from "./normalize.ts";
import { canonCompact, canonId } from "./ids.ts";
